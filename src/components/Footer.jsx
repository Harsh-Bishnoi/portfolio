...
const socialLinks = [
    {
        href: "https://github.com/Harsh-Bishnoi",
        label: "GitHub",
        svg: (
            <svg fill="currentColor" stroke="none" strokeWidth="0" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
    ...
    {
        href: "mailto:harshbishnoi855@gmail.com",
        label: "Email",
        svg: (
            <svg fill="currentColor" stroke="none" strokeWidth="0" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
...
const Footer = () => {
    ...
    return (
        <footer
            ref={footerRef}
            className="text-black bg-[#CCCCCC] pt-12"
